...
function CardHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "group/card-header flex flex-col gap-1.5 px-6 group-data-[size=sm]/card:px-4",
        className,
      )}
      {...props}
    />
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      // design calls for bold headers
      className={cn(
        "font-heading text-foreground text-lg font-bold tracking-tight",
        className,
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "mt-auto flex items-center px-6 group-data-[size=sm]/card:px-4",
        className,
      )}
      {...props}
    />
