  ...
  return (
    <Dialog open={open} onOpenChange={(val) => !val && onClose()}>
      <DialogContent
        ...
        className="fixed top-1/2 left-1/2 z-60translate-x-1/2 -translate-y-1/2 bg-card p-6 flex flex-col w-74.25 h-86.5 sm:w-113 sm:h-80.5 rounded-[8px] border-none shadow-lg focus:outline-none"
      >
        <div className="flex flex-col justify-between w-62.25 h-74.5 sm:w-101 sm:h-68.5">
          <div className="flex items-center justify-between w-full h-11.75 sm:h-10.25">
            <div className="flex items-center min-w-0">
              <div className="w-10 h-10 rounded-full bg-[#E8E8E8] flex shrink-0 items-center justify-center border-[1.5px]">
                <Share2 className="size-4 text-[#111928]" strokeWidth={1.5} />
              </div>

              <div className="ml-3 flex flex-col justify-center min-w-0 h-11.75 sm:h-10.25 gap-2">
                <p 
                  className="font-semibold text-[#141414] truncate text-sm sm:text-base leading-5.25 sm:leading-none w-22 sm:w-54.5"
                >
                  Share Report
                </p>
                <p 
                  className="font-normal text-[#666666] truncate text-xs sm:text-sm leading-4.5 sm:leading-none w-14.5 sm:w-55.25"
                >
                  {formattedMonthYear}
                </p>
              </div>
          ...
          <div className="flex items-center bg-[#F5F5F5] rounded-(--radius) w-62.25 h-23.5 sm:w-101 sm:h-19 p-4 gap-2 sm:mt-6">
            <div className="flex shrink-0 items-center justify-center">
              <Calendar className="w-4.5 h-4.25 text-[#F5A623]" strokeWidth={2} />
            </div>

            <div className="ml-2 flex flex-col justify-center gap-2 w-30.25 sm:w-67 min-w-0">
              <p className="font-semibold text-sm text-[#141414] truncate leading-none">
                {report.title}
              </p>
              <p className="font-normal text-sm text-[#5D5C5D] truncate leading-none">
                PDF {report.subtitle}
              </p>
            </div>
          ...
          <div className="flex gap-4 w-62.25 h-19.25 sm:w-101">
            <Button
              ...
              className="w-[116.5px] sm:w-48.5 h-19.25 flex flex-col items-center justify-center rounded-(--radius) p-3 gap-2 border border-[#E8E8E8] bg-[#EDEDED] cursor-pointer hover:bg-[#E2E2E2] hover:border-[#D0D0D0] transition-all hover:text-foreground"
            >
              <Mail className="w-8 h-8 text-[#141414]" />

              <span className="font-medium text-base text-[#141414] leading-none">
                Email
              </span>
            </Button>
            ...
            <Button
              ...
              className="w-[116.5px] sm:w-48.5 h-19.25 flex flex-col items-center justify-center rounded-(--radius) p-3 gap-2 border border-[#E8E8E8] bg-[#EDEDED] cursor-pointer hover:bg-[#E2E2E2] hover:border-[#D0D0D0] transition-all hover:text-[#057552]"
            >
              <svg viewBox="0 0 24 24" fill="#057552" className="w-8 h-8">
          ...
          <div className="flex justify-start w-24 h-6 mt-4">
            ...
            >
              <div className="w-6 h-6 flex items-center justify-center">
                <Copy className="size-4 text-[#141414]" />
              </div>
              <span className="font-normal text-sm text-[#141414] w-16 h-4.5 ml-2 leading-none flex items-center">
                Copy Link
              </span>
            </Button>
          </div>
